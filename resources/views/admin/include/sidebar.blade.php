    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item  {{request()->is('admin/sections') ?'menu-open':'' }} {{request()->is('admin/add-edit-product') ?'menu-open':'' }} {{request()->is('admin/products') ?'menu-open':'' }} {{request()->is('admin/categories') ?'menu-open':'' }} {{request()->is('admin/add-edit-category') ?'menu-open':'' }}">
                    <a href="#" class="nav-link {{request()->is('admin/sections') ?'active':'' }}  {{request()->is('admin/products') ?'active':'' }} {{request()->is('admin/add-edit-product') ?'active':'' }} {{request()->is('admin/categories') ?'active':'' }} {{request()->is('admin/add-edit-category') ?'active':'' }}">
                        <i class="nav-icon fas fa-th"></i>
                        <p> Catalogues </p>
                    </a>
                    <ul class="nav nav-treeview">
